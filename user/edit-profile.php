<?php
    ...
    {   
        ...
        $query1 = "SELECT * from user where username='$username'  and userId!=$id";
        ...
        if(mysqli_num_rows($result1)>0)
        {
            ...
            $query = "UPDATE `user` SET `name`='$name',`username`='$username',`emailId`='$email',`mobileNo`='$mobileNo' WHERE userId=$id;";
            $query .= "UPDATE `news` SET `userName`='$username',`name`='$name' WHERE userId=$id AND `postBy`='user'";
