    ...
    <div class="navcontainer1">
        <nav class="navitem">
            ...
            <div class="logoutitem">
                ...
                <div class="user">
                    <div class="logout">
                        <div class="username" onclick="menuToggle()"><?php echo $_SESSION['username']; ?></div>
                    </div>
                    <div class="menu">
                        <ul>
                            <li><a href="edit-profile.php?id=<?php echo $_SESSION['userId']; ?>"><i class="fas fa-edit"></i>Edit Profile</a></li>
                            <li><a href="change-password.php?id=<?php echo $_SESSION['userId']; ?>"><i class="fas fa-lock"></i>Change Password</a></li>
