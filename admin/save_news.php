<?php
    ...
    $query = "INSERT INTO `news`(`newsCategory`, `newsTitle`, `newsDescription`, `Image`, `newsDate`, `postBy`,`publish`, `userId`,`userName`,`name`) VALUES ('$category','$newsTitle','$newsDiscription','$fileName','$date','admin','published','$userId','$username','$name');";
    $query .= "UPDATE `category` SET `totalNews` = `totalNews`+1 WHERE `categoryId` = $category;";
