<?php
    ...
    $date = date('Y-m-d');
    $userId = $_SESSION['publisherId'];
    $name = $_SESSION['publishername'];
    $username = $_SESSION['publisherUserName'];
    $query = "INSERT INTO `news`(`newsCategory`, `newsTitle`, `newsDescription`, `Image`, `newsDate`, `postBy`,`publish`, `userId`,`userName`,`name`) VALUES ('$category','$newsTitle','$newsDiscription','$fileName','$date','publisher','publish','$userId','$username','$name');";
